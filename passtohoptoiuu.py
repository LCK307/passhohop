...
def calculate_permutations():
    ...
    while True:
        ...
        # Tính toán tất cả các hoán vị và loại bỏ các hoán vị trùng lặp
        permutations = list(set(itertools.permutations(characters)))
        
        # Giới hạn số lượng hoán vị nếu người dùng yêu cầu
